...
const internalProjects = [
  {
    ...
    date: "2025–Present",
    desc: "AI-Vision Camera & Alert Management System — microservice platform with API Gateway, Auth BFF, Keycloak SSO, Ed25519 PKI licensing, Kafka SOC alerts, and RTSP/HLS camera ops across HEX, DFX, and WebX products.",
    summary:
      "Enterprise dual-deployment (standalone + multi-tenant SaaS) with shared Auth, Gateway, and Licensing reused across three products.",
    highlights: [
      "Microservice platform behind License Guard → JWT/DPoP Guard → CSRF Guard → Proxy",
      "Per-tenant Ed25519 licensing with machine fingerprinting, heartbeat anti-rollback, fail-closed startup",
      "Zero-trust BFF auth: Keycloak PKCE, httpOnly JWTs, DPoP-bound tokens, Redis refresh rotation",
      "Cross-product SSO (WebX → HEX) via Redis single-use handoff + Keycloak token exchange",
      "Real-time SOC pipeline: Kafka ingestion, Socket.IO fan-out, alert lifecycle",
      "Camera/AI ops: RTSP → FFmpeg → HLS streaming, ROI configuration, rights-gated React modules",
    ],
    tech: [
      "NestJS",
      "React.js",
  ...
  },
  {
    icon: "👥",
    iconWrap: "bg-a2/10",
    title: "Resource Management Portal (RMG)",
    date: "2025–Present",
    desc: "Full-stack recruitment workflow system (lead → requirement → resource) with JWT auth, RBAC, and an analytics dashboard.",
    summary:
      "Lead & recruitment lifecycle management with role-based access and workflow analytics.",
    highlights: [
      "JWT authentication with access/refresh tokens and RBAC",
      "Lead management, requirement creation with JD uploads, candidate pipeline",
      "Candidate segmentation — Bench, Placed, Released resource tracking",
      "Relational schema linking leads, requirements, resources, roles, and users",
      "Dashboard analytics APIs and automated email notifications",
    ],
    tech: [
      "NestJS",
      "React.js",
