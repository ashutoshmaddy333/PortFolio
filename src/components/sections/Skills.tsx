...
const cards = [
  {
    ...
    sub: "NestJS · Microservices · API Gateway",
    tags: [
      { t: "NestJS", c: "b" },
      { t: "Node.js", c: "b" },
      { t: "TypeScript", c: "b" },
  ...
  },
  {
    ...
    sub: "React ecosystem · 1+ yr industry",
    tags: [
      { t: "React.js", c: "g" },
      { t: "TypeScript", c: "g" },
      { t: "Redux Toolkit", c: "g" },
  ...
  },
  {
    ...
    iconClass: "bg-a4/10",
    title: "Platform & SaaS",
    sub: "Multi-tenant · Licensing · BFF",
    tags: [
      { t: "Multi-tenant SaaS", c: "p" },
      { t: "BFF Auth", c: "p" },
      { t: "Cross-product SSO", c: "p" },
      { t: "PKI Licensing", c: "p" },
      { t: "HEX / DFX / WebX", c: "p" },
    ],
  },
